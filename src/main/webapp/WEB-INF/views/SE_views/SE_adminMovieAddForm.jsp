...
<body>
	<div class="container">
		...
		<div class="movieInfo-form">
			<form action="adminMovieAdd" name="addMovie" method="post"
					...
					<li><label class="movieInfoName">추천수</label>
						<div class="movieInfo">
							<input type="text" id="movieRecommendation"
								name="mo_recommendation">
						</div></li>
					<br>
					<li><label class="movieInfoName">포스터</label>
						<div class="movieInfo">
							<input type="file" id="movieFileName" name="file">
						</div></li>
					<br>
					<input type="hidden" name="path"
						value="${pageContext.request.contextPath}/resources/static/Img/">
				</ul>

				<div class="adminBtn">
					<button type="submit" value="등록" id="movieAdd"
						onclick="movieAddClick()">등록</button>
